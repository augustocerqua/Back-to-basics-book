...
where $Post_t=\mathbf{1}(t\geq T_0)$ and $T_0$ denotes the first period affected by the intervention. In this specification, $\beta$ captures the pre-intervention trend, $\gamma$ captures the immediate level change at the intervention, and $\delta$ captures the change in trend after the intervention. Thus, the post-intervention trend is $\beta+\delta$.
