...
A good continuous-treatment evaluation should report:

- why treatment intensity matters for the policy question;
- how treatment intensity is measured;
- the distribution of treatment intensity;
- the dose-response function and uncertainty bands;
- the identifying assumptions used to interpret the curve causally;
- how the treatment model or balancing procedure was estimated;
- covariate balance across treatment intensity;
- common support and any restrictions to the dose range;
- sensitivity to alternative specifications;
- the policy-relevant range of treatment intensity.
