...
where $f(\cdot)$ and $g(\cdot)$ are parametric functions of the running variable on the two sides of the cutoff. This model allows the relationship between the running variable and the outcome to differ on either side of the cutoff, thereby accommodating potential nonlinearities around the threshold.
