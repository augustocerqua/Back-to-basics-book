...
The argument is that individuals who grow up closer to a college face lower costs of attending college and are therefore more likely to obtain more schooling. At the same time, proximity to college is assumed to affect wages only through schooling, rather than through other direct channels.^[This second condition is an identifying assumption, not an observable fact: proximity to college could in principle be related to other characteristics of local areas or families that also affect wages.]
...
The instrument isolates variation in schooling associated with geographic access to college rather than with unobserved determinants of schooling and wages. Using this variation, Card finds IV estimates of the return to schooling that are substantially larger than conventional OLS estimates—roughly 25–60% higher across his specifications. He also finds that the schooling effects of college proximity are concentrated among individuals from less-educated families, for whom access to a nearby college is more likely to affect educational attainment.
