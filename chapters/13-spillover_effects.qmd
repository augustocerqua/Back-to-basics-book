...
If some untreated units are plausibly unexposed, they can be used as a control group to estimate direct effects. Treated units can then be compared with unexposed untreated units using familiar methods such as matching, DiD, RD, or SCM.
