...
In this model, $\alpha$ is the average outcome for untreated units, while $\beta$ captures the difference in average observed outcomes between treated and untreated units. The term $u_i$ is the error term: it captures all factors affecting the outcome that are not included in the regression.
